 ...
 * Contains theme override functions and process & preprocess functions for alixxor
...
if (theme_get_setting('alixxor_clear_registry')) {
...
function alixxor_html_head_alter(&$head_elements) {
...
function alixxor_preprocess_search_block_form(&$vars) {
...
function alixxor_preprocess(&$vars, $hook) {

  $vars['alixxor_path'] = base_path() . path_to_theme();
...
function alixxor_preprocess_html(&$vars) {

  

  $vars['doctype'] = _alixxor_doctype();

  $vars['rdf'] = _alixxor_rdf($vars);
  ...
  if (!$vars['is_front']) {
    ...
    if (isset($page_name)) {
      ...
      $vars['classes_array'][] = alixxor_id_safe('page-' . $page_name);

    }



    $vars['classes_array'][] = alixxor_id_safe('section-' . $section);
...
function alixxor_preprocess_page(&$vars) {
...
function alixxor_preprocess_maintenance_page(&$vars) {
  ...
  drupal_add_css(drupal_get_path('theme', 'alixxor') . '/css/maintenance-page.css');
...
function alixxor_preprocess_node(&$vars) {
...
function alixxor_preprocess_block(&$vars, $hook) {
...
function alixxor_menu_tree($vars) {
...
function alixxor_field__taxonomy_term_reference($vars) {
...
function alixxor_breadcrumb($vars) {
...
// Determine if we are to display the breadcrumb.
  ...
  $show_breadcrumb = theme_get_setting('alixxor_breadcrumb_display');

  if ($show_breadcrumb == 'yes') {

  

	  if (theme_get_setting('alixxor_breadcrumb_hideonlyfront')) {
	  ...
	  if(theme_get_setting('alixxor_breadcrumb_showtitle')) {
	  ...
	  $separator = theme_get_setting('alixxor_breadcrumb_separator');
...
function alixxor_tabs_float() {

  $float = (bool) theme_get_setting('alixxor_tabs_float');

  $float_node = (bool) theme_get_setting('alixxor_tabs_node');
...
function alixxor_id_safe($string) {
...
function alixxor_menu_link(array $vars) {
  ...
  $element['#attributes']['class'][] = alixxor_id_safe($element['#title']);
...
function alixxor_preprocess_menu_local_task(&$vars) {
...
function alixxor_menu_local_tasks(&$vars) {

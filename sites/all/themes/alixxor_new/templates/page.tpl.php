  ...
  <div id="page">
    <div id="header">
      ...
      <div class="section-1 clearfix">
        ...
        <div class="col2"> <?php print render($page['user_menu']); ?> </div>
        <?php endif; ?>
      </div>
    </div>
    <div id="whole_menu">
      <div id="menu_area">
        <?php if ($page['menu']): ?>
        <div class="section-2 clearfix <?php if ($page['header_bottom'] && !$page['header']): ?>indent<?php endif; ?>"> <?php print render($page['menu']); ?> </div>
        <?php endif; ?>
      </div>
    </div>
    <div class="page ">
      <?php if ($page['header']): ?>
      <div class="section-3 clearfix"> <?php print render($page['header']); ?> </div>
      <!-- /.section -->
      <?php endif; ?>
      <?php if ($page['header_bottom']): ?>
      <div class="section-4 clearfix"> <?php print render($page['header_bottom']); ?> </div>
      <!-- /.section -->
      <?php endif; ?>
      </header>
      <!-- /#header -->
        ...
        <div id="main" class="clearfix">
          ...
          <div id="content" class="column" role="main">
            <div class="section">
              ...
              <?php endif; ?>
              <?php print render($page['content_top']); ?> <?php print render($page['content']); ?> </div>
            <!-- /.section -->
          </div>
          <!-- /#content -->
    ...
    <footer id="footer" role="contentinfo">
      <div class="footer-wrapper clearfix"> <?php print render($page['footer']); ?> </div>
      <!-- /#footer-wrapper -->
    </footer>
    <!-- /#footer -->
  </div>

...
<strong>A customer at Alixxor has just placed an order.</strong>
<p></p>
<p></p>
			        ...
			        ?>
                      <tr>
                        ...
                        ?>
                         ...
                         <td class="views-field views-field-line-item-title" style="border-bottom:1px solid #46BF56;width:400px;">
						 <?php  print $product_data->title; ?>
                         </td>
           
                         <td class="views-field views-field-commerce-total views-align-right" style="text-align:right; padding-right: 18px; border-bottom:1px solid #46BF56;">
						 <?php print commerce_currency_format($line_item->commerce_total['und'][0]['amount'],'USD'); ?> 
						 </td>
                        </tr>
                        <?php 
			}
